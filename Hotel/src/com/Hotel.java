...
public class Hotel {
    ...
    public static void main(String[] args) {
        ...
        Guest guest1 = guestService.addGuest("G1", "g1");
        Guest guest2 = guestService.addGuest("G2", "g2");
        Guest guest3 = guestService.addGuest("G3", "g3");
        Guest guest4 = guestService.addGuest("G4", "g4");
